...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['recruitment-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Profile Searches',
      path: '/profile-searches',
      entity: 'profile_search',
      service: AccessServiceEnum.PROJECT,
      icon: FiSearch,
    },
    { name: 'Vacancies', path: '/vacancies', entity: 'vacancy', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
