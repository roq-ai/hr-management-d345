...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'profile_search.create': {
    roles: ['recruitment-manager'],
    key: 'new-profile-search',
    tenantPath: ['organization', 'profile_search'],
    userPath: [],
  },
  'profile_search.update': {
    roles: ['recruitment-manager'],
    key: 'update-profile-search',
    tenantPath: ['organization', 'profile_search'],
    userPath: [],
  },
  'profile_search.delete': {
    roles: ['recruitment-manager'],
    key: 'delete-profile-search',
    tenantPath: ['organization', 'profile_search'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['recruitment-manager'];
